...
const InputForm = forwardRef<HTMLInputElement, Props>(
    ({ name, type, label, onChange, error, required, textColor, max, ...rest }, ref) => {
            ...
            <div>
                <div className="relative">
                    <input
                        ...
                        onChange={onChange}
                        placeholder=" "
                        className={`peer w-full px-4 pt-5 pb-2 border rounded-lg focus:outline-none focus:border-blue-500 [color-scheme:dark] ${textColor} ${
                    ...
                    <label
                        htmlFor={name}
                        className={`${textColor} absolute left-4 top-1/2 -translate-y-1/2 text-base transition-all duration-200 pointer-events-none
